<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-900">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <form class="relative flex items-center" method="GET" action="{{ route('posts.index') }}">
                <input
                type="text"
                placeholder="Search..."
                class="w-80 py-2 pl-10 pr-4 text-sm text-gray-700 bg-gray-100 dark:bg-gray-700 dark:text-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:bg-white dark:focus:bg-gray-600"
                value="{{ request('query') }}"
                name="query"
                />
                <div class="absolute inset-y-0 left-0 flex items-center pl-3">
                    <button type="submit">
                        <svg class="w-5 h-5 text-gray-500 dark:text-gray-400 hover:text-indigo-500 dark:hover:text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <button title="Toggle Dark Mode" id="theme-toggle" type="button" class="h-fit my-auto ml-4 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 sm:fixed sm:bottom-4 sm:right-4 sm:z-10">
