                ...
                <div class="bg-gray-800/90 backdrop-blur-sm rounded-2xl shadow-xl overflow-hidden border border-gray-700/50 transform transition-all hover:scale-[1.01] duration-300">
                    ...
                    <div class="p-8">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mb-5">
                                <label for="remember_me" class="inline-flex items-center cursor-pointer">
                                    <input 
                                        id="remember_me" 
                                        type="checkbox" 
                                        class="rounded border-gray-600 text-purple-600 shadow-sm focus:border-purple-300 focus:ring focus:ring-purple-200 focus:ring-opacity-50 bg-gray-700 transition-colors" 
                                        name="remember"
                                    >
                            ...
                            <div class="flex items-center justify-between mb-6">
                                @if (Route::has('password.request'))
                                    <a class="text-sm font-medium text-purple-400 hover:text-purple-300 transition-colors" href="{{ route('password.request') }}">
                        ...
                        <div class="mt-6 text-center">
                            ...
                            <a href="{{ route('register') }}" class="ml-1 text-sm font-medium text-purple-400 hover:text-purple-300 transition-colors">
                                Sign up
                            </a>
                        </div>
                    </div>
