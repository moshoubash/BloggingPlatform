<x-app-layout>
    <div class="relative" style="max-width: 1200px; margin: auto;">
        ...
        <div class="flex flex-col md:flex-row" style="position: relative; top: -125px;">
            <div class="w-full p-4">
                ...
                @else
                    <p class="text-lg font-semibold mb-4 text-gray-800 dark:text-white">No posts found.</p>
                @endif
            </div>
        </div>
    </div>
